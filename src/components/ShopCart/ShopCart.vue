...
export default {
  ...
  computed: {
    ...
    payText () {
      // ￥20元起送  还差￥10 元起送  结算
      const { totalPrice, totalCount } = this
    ...
    showList () {
      ...
      this.$nextTick(() => {
        !this.foodsScroll ? (this.foodsScroll = new BScroll('.list-content', { click: true })) : this.foodsScroll.refresh()
      })
